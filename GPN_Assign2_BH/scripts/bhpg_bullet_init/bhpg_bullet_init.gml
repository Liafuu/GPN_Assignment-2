/// @description bhpg_bullet_init(bullet object, bullet speed, bullet acceleration, bullet curve);
/// @param bullet object
/// @param  bullet speed
/// @param  bullet acceleration
/// @param  bullet curve
function bhpg_bullet_init(argument0, argument1, argument2, argument3) {
